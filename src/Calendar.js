...
class Calendar extends React.Component {
  ...
  getContext({
    ...
    return {
      ...
      accessors: {
        openModal: wrapAccessor(openModal),
        ...
        validation: wrapAccessor(validation),
        isSimulated: wrapAccessor(isSimulated),
        tempId: wrapAccessor(tempIdAccessor),
        date: wrapAccessor(dateAccessor),
        created_by: wrapAccessor(createdByAccessor),
        respawn: wrapAccessor(respawnAccessor),
