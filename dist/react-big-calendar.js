  ...
  */
  ...
  function () {
    function Selection(node, _temp) {
      ...
      this._onTouchMoveWindowListener = addEventListener$1('touchmove', function () {}, window);
    ...
    _proto._addLongPressListener = function _addLongPressListener(handler, initialEvent) {
      ...
      var touchStartListener = addEventListener$1('touchstart', handleTouchStart);
    ...
    _proto._addInitialEventListener = function _addInitialEventListener() {
      ...
      var mouseDownListener = addEventListener$1('mousedown', function (e) {
        ...
        _this2._onInitialEventListener = addEventListener$1('mousedown', _this2._handleInitialEvent);
      });
    ...
    _proto._handleInitialEvent = function _handleInitialEvent(e) {
      ...
      switch (e.type) {
        case 'mousedown':
          this._onEndListener = addEventListener$1('mouseup', this._handleTerminatingEvent);
          this._onEscListener = addEventListener$1('keydown', this._handleTerminatingEvent);
          this._onMoveListener = addEventListener$1('mousemove', this._handleMoveEvent);
          break;

        case 'touchstart':
          this._handleMoveEvent(e);

          this._onEndListener = addEventListener$1('touchend', this._handleTerminatingEvent);
          this._onMoveListener = addEventListener$1('touchmove', this._handleMoveEvent);
          break;
  ...
  function getSlotMetrics$1(_ref) {
    ...
    return {
      ...
      getRange: function getRange(rangeStart, rangeEnd, t2end, t3start) {
        ...
        var t2rangeEnd = positionFromDate(t2end);
        var t3rangeStart = positionFromDate(rangeEnd, t3start);
        var t2t3 = positionFromDate(t3start, t2end);
  ...
  function () {
    function Event(data, _ref) {
      ...
      var _slotMetrics$getRange = slotMetrics.getRange(accessors.start(data), accessors.end(data), accessors.t2(data), accessors.t3(data)),
          ...
          t2 = _slotMetrics$getRange.t2,
          t2height = _slotMetrics$getRange.t2height,
          t3 = _slotMetrics$getRange.t3,
          t3height = _slotMetrics$getRange.t3height,
          t2t3 = _slotMetrics$getRange.t2t3,
          t2t3height = _slotMetrics$getRange.t2t3height;
  ...
  function (_React$Component) {
    ...
    _proto.viewNamesGroup = function viewNamesGroup(messages) {
      ...
      var view = this.props.view; // if (viewNames.length > 1) {
