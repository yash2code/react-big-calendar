!(function(e, t) {
  ...
  var Se = function(e) {
      ...
      e = e.replace(_e, '')
      var n = Me.test(e)
      return n || Oe.test(e) ? De(e.slice(2), n ? 2 : 8) : Ee.test(e) ? we : +e
    },
    Te = 1 / 0,
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            D = v.start(i),
            S = v.allDay(i),
            T = l || S || W.diff(D, W.ceil(O, 'day'), 'day') > 1,
            j = h.eventProp(i, D, O, s),
            x = n.createElement(
              'div',
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              o({}, w, {
                style: o({}, j.style, t),
                className: M('rbc-event', r, j.className, {
                  'rbc-selected': s,
                  'rbc-event-allday': T,
  ...
  var Oo = function(e, t, n, r) {
    ...
    for (; ++o < a; ) {
      ...
      if (i && s[2]) {
        ...
        if (!(void 0 === d ? _o(u, c, Eo | Mo, r, f) : d)) return !1
      }
    }
    return !0
  }
  ...
  var Sa = (function(e) {
      ...
      return (
        ...
        (r.renderHeadingCell = function(e, t) {
          ...
          return o({
            date: e,
            key: 'header_' + t,
            className: M('rbc-date-cell', W.eq(e, a(), 'day') && 'rbc-now'),
          })
        }),
    ...
    return (
      (a.getRowLimit = function() {
        var e = Mt(this.eventRow),
          n = this.headingRow ? Mt(this.headingRow) : 0,
          r = Mt(t.findDOMNode(this)) - n
      ...
      ),
      {
        ...
        getRange: function(e, o, a, i) {
          ...
          return {
            ...
            endDate: o,
            t2end: u,
            t2height: (u / (r * c)) * 100 - p,
            t3start: f,
            t3height: (f / (r * c)) * 100,
            t2t3range: d,
            t2t3height: (d / (r * c)) * 100,
          }
        },
      }
    )
  ...
  var ni = function(e, t) {
    ...
    oi = (function() {
      function e(e, t) {
        var n = t.accessors,
          r = t.slotMetrics.getRange(n.start(e), n.end(e), n.t2(e), n.t3(e)),
          o = r.start,
          a = r.startDate,
          i = r.end,
          s = r.endDate,
        ...
        ;(this.start = o),
          ...
          (this.data = e),
          (this.t2 = u),
          (this.t2height = (f / c) * 100),
          (this.t3 = d),
          (this.t3height = (p / c) * 100),
          (this.t2t3 = v),
          (this.t2t3height = (h / c) * 100)
      }
      var t, n, r
      return (
        (t = e),
  ...
  function ci(e) {
    var t,
      ...
      h = e.onDoubleClick,
      m = e.components,
      y = (m.event, m.eventWrapper),
      g = (s.title(i), s.tooltip(i)),
      b = s.end(i),
      w = s.start(i),
      _ = (s.t2(i), s.t3(i), p.eventProp(i, w, b, c)),
      E = r.height,
      O = r.top,
      D = r.width,
      S = r.xOffset,
      ...
      C = [
        n.createElement('div', {
          ...
          style: { width: '100%', height: T + '%', background: 'red' },
        }),
        n.createElement('div', {
          key: '2',
          className: 'rbc-event-second',
          style: { width: '100%', height: x + '%', background: 'blue' },
        }),
        n.createElement('div', {
          key: '3',
          className: 'rbc-event-third',
          style: { width: '100%', height: j + '%', background: 'green' },
        }),
      ]
    return n.createElement(
      y,
      ...
      n.createElement(
        'div',
        {
          ...
          style: o(
            ...
            (t[l ? 'right' : 'left'] = Math.max(0, S) + '%'),
            (t.width = D + '%'),
            t)
          ),
          title: g ? ('string' == typeof u ? u + ': ' : '') + g : void 0,
          className: M('rbc-event', a, _.className, {
            'rbc-selected': c,
        ...
        return e.map(function(e, r) {
          ...
          return n.createElement(
            'div',
            {
              key: r,
              style: p,
              className: M('rbc-header', d, W.eq(e, u, 'day') && 'rbc-today'),
            },
            i
              ? n.createElement(
                  'a',
      ...
      (r.render = function() {
        ...
        return n.createElement(
          'div',
          {
            style: w,
            ref: p,
            className: M('rbc-time-header', h && 'rbc-overflowing'),
          },
          n.createElement(
            'div',
            {
  ...
  var Di,
    Si = function(e, t) {
      e.classList
        ...
        : 'string' == typeof e.className
        ? (e.className = Oi(e.className, t))
        : e.setAttribute(
            'class',
            Oi((e.className && e.className.baseVal) || '', t)
          )
    },
    Ti = c(function(e, t) {
      ;(t.__esModule = !0), (t.default = void 0)
  ...
  var Pi = (function(e) {
    ...
    return (
      ...
      (r.viewNamesGroup = function(e) {
        this.props.views, this.props.view
      }),
      t
    )
  })(n.Component)
    ...
    return (
      ...
      (r.render = function() {
        ...
        return n.createElement(
          'div',
          o({}, c, {
            className: M(l, 'rbc-calendar', h.rtl && 'rbc-is-rtl'),
            style: s,
          }),
          r &&
            n.createElement(O, {
