...
var _svgnav = _interopRequireDefault(require("./assets/svgnav1.svg"));

var _svgnav2 = _interopRequireDefault(require("./assets/svgnav2.svg"));
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        label = _this$props.label; // console.log(messages)
    ...
    }, label), _react.default.createElement("img", {
      src: _svgnav2.default,
      name: "chevron-right",
