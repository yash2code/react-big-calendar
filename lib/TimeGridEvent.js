...
function TimeGridEvent(props) {
  ...
  var date_created = (0, _moment.default)(accessors.date(event)).format('lll'); // console.log(moment(start).format('LT'))
  ...
  return _react.default.createElement(EventWrapper, (0, _extends3.default)({
    ...
    style: (0, _extends3.default)({}, userProps.style, (_extends2 = {
      ...
      border: 'none',
      padding: 0
    }, _extends2[isRtl ? 'right' : 'left'] = Math.max(0, xOffset) + "%", _extends2.width = width + "%", _extends2.maxWidth = '45px', _extends2)),
  ...
  }, _react.default.createElement("li", null, "Total Duration: ", _react.default.createElement("span", null, duration + " mins")), _react.default.createElement("li", null, "Type: ", _react.default.createElement("span", null, type)), _react.default.createElement("li", null, "Total Respawns : ", _react.default.createElement("span", null, respawn))), _react.default.createElement("hr", null), _react.default.createElement("div", {
  ...
  }, _react.default.createElement("p", null, "Created By: " + created_by), _react.default.createElement("p", null, date_created))));
}
