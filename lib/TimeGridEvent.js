...
function TimeGridEvent(props) {
  ...
  return _react.default.createElement(EventWrapper, (0, _extends3.default)({
    ...
    style: (0, _extends3.default)({}, userProps.style, (_extends2 = {
      ...
      border: 'none',
      padding: '3px'
    }, _extends2[isRtl ? 'right' : 'left'] = validation ? 0 : Math.max(0, xOffset) + "%", _extends2.width = validation ? '100%' : width + "%", _extends2.maxWidth = validation ? '100%' : 15 + "%", _extends2)),
    ...
    className: "row-1"
  }, _react.default.createElement("p", null, "Created By: " + (created_by && created_by.split(' ')[0])), _react.default.createElement("p", {
    className: "view-more"
  }, _react.default.createElement("a", {
    onClick: function onClick() {
      return openModal(tempId);
    }
  }, "View More"))), _react.default.createElement("p", null, date_created))));
}
