...
function TimeGridEvent(props) {
  ...
  return _react.default.createElement(EventWrapper, (0, _extends3.default)({
  ...
  }, _react.default.createElement("li", null, "Total Duration: ", _react.default.createElement("span", null, duration + " mins")), _react.default.createElement("li", null, "Percentage: ", _react.default.createElement("span", null, type + "% Winners")), _react.default.createElement("li", null, "Type: ", _react.default.createElement("span", null, "" + wdf))), _react.default.createElement("hr", null), _react.default.createElement("div", {
    ...
    className: "row-1"
  }, _react.default.createElement("p", null, "Created By: " + created_by), _react.default.createElement("p", null, _react.default.createElement("a", null, "View More"))), _react.default.createElement("p", null, date_created))));
}
