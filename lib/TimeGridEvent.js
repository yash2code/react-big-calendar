...
function TimeGridEvent(props) {
  ...
  var tempId = accessors.tempId(event)
  var openModal = accessors.openModal(event)
  ...
  return _react.default.createElement(
    ...
    _react.default.createElement(
      'div',
      {
        ...
        style: (0, _extends3.default)(
          ...
          (_extends2[isRtl ? 'right' : 'left'] = validation
            ? 0
            : Math.max(0, xOffset) + '%'),
          (_extends2.width = validation ? '100%' : width + '%'),
          (_extends2.maxWidth = validation ? '100%' : '45px'),
          _extends2)
        ),
        title: tooltip
    ...
    _react.default.createElement(
      ...
      _react.default.createElement(
        ...
        _react.default.createElement('p', null, gems + ' gems')
      ),
      ...
      _react.default.createElement(
        ...
        _react.default.createElement(
          ...
          null,
          'Total Duration: ',
          _react.default.createElement('span', null, duration + ' mins')
        ),
        _react.default.createElement(
          'li',
          null,
          'Type: ',
          _react.default.createElement('span', null, type + '% Winners')
        ),
        _react.default.createElement(
          'li',
          null,
      ...
      _react.default.createElement(
        ...
        _react.default.createElement(
          'section',
          null,
          _react.default.createElement('p', null, 'T1: ' + t1),
          _react.default.createElement('p', null, 'T2: ' + t2)
        ),
        _react.default.createElement(
          'section',
          null,
          _react.default.createElement('p', null, 'T3: ' + t3),
          _react.default.createElement('p', null, 'T4: ' + t4)
        )
      ),
      _react.default.createElement('hr', null),
      _react.default.createElement(
        ...
        _react.default.createElement(
          ...
          _react.default.createElement(
            'p',
            null,
            'Created By: ' + (created_by && created_by.split(' ')[0])
          ),
          _react.default.createElement(
            'p',
            {
        ...
        _react.default.createElement('p', null, date_created)
      )
    )
  )
}
