...
function (_React$Component) {
  ...
  _proto.getContext = function getContext(_ref2) {
    var startAccessor = _ref2.startAccessor,
        ...
        colorAccessor = _ref2.colorAccessor,
        gemsAccessor = _ref2.gemsAccessor,
        validation = _ref2.validation,
        isSimulated = _ref2.isSimulated,
        typeAccessor = _ref2.typeAccessor,
        respawnAccessor = _ref2.respawnAccessor,
        openModal = _ref2.openModal,
        dateAccessor = _ref2.dateAccessor,
        wdfAccessor = _ref2.wdfAccessor,
        allDayAccessor = _ref2.allDayAccessor,
        createdByAccessor = _ref2.createdByAccessor,
        tooltipAccessor = _ref2.tooltipAccessor,
        tempIdAccessor = _ref2.tempIdAccessor,
    ...
    return {
      ...
      accessors: {
        openModal: (0, _accessors.wrapAccessor)(openModal),
        start: (0, _accessors.wrapAccessor)(startAccessor),
        end: (0, _accessors.wrapAccessor)(endAccessor),
        t2: (0, _accessors.wrapAccessor)(t2Accessor),
        t3: (0, _accessors.wrapAccessor)(t3Accessor),
        wdf: (0, _accessors.wrapAccessor)(wdfAccessor),
        color: (0, _accessors.wrapAccessor)(colorAccessor),
        gems: (0, _accessors.wrapAccessor)(gemsAccessor),
        type: (0, _accessors.wrapAccessor)(typeAccessor),
        validation: (0, _accessors.wrapAccessor)(validation),
        isSimulated: (0, _accessors.wrapAccessor)(isSimulated),
        tempId: (0, _accessors.wrapAccessor)(tempIdAccessor),
        date: (0, _accessors.wrapAccessor)(dateAccessor),
        created_by: (0, _accessors.wrapAccessor)(createdByAccessor),
        respawn: (0, _accessors.wrapAccessor)(respawnAccessor),
...
Calendar.defaultProps = {
  ...
  respawnAccessor: 'respawn',
  startAccessor: 'start',
  isSimulated: 'isSimulated',
  endAccessor: 'end',
  dateAccessor: 'date',
  createdByAccessor: 'created_by',
...
Calendar.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   * @type {(func|string)}
   */
  t2Accessor: _propTypes2.accessor,
   ...
   * @type {(func|string)}
   */
  t3Accessor: _propTypes2.accessor,
