...
function getSlotMetrics(_ref) {
  ...
  return {
    ...
    getRange: function getRange(rangeStart, rangeEnd, t2end, t3start) {
      ...
      var t3rangeStart = positionFromDate(t3start); // const t2t3 = positionFromDate(t3start, t2end)

      var top = rangeStartMin / (step * numSlots) * 100;
      var t2height = t2rangeEnd / (step * numSlots) * 100 - top;
      var height = rangeEndMin / (step * numSlots) * 100 - top;
      var t2t3height = t3rangeStart / (step * numSlots) * 100 - top - t2height; // console.log(t2height, 't2----')
