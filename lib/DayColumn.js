...
var _tablerReact = require("tabler-react");
...
var Box = _reactPose.default.div(props);
...
function (_React$Component) {
  ...
  function DayColumn() {
    ...
    _this._selectCurrent = function () {
      ...
      (0, _helpers.notify)(_this.props.onSelectCurrent, args);
    };
    ...
    _this.fun = _this.fun.bind((0, _assertThisInitialized2.default)(_this));
    _this.onEnd = _this.onEnd.bind((0, _assertThisInitialized2.default)(_this));
    _this._selectCurrent = _this._selectCurrent.bind((0, _assertThisInitialized2.default)(_this));
    return _this;
  }
  ...
  _proto.getDstOffset = function getDstOffset(start, end) {
    return start.getTimezoneOffset() - end.getTimezoneOffset();
  };

  _proto.positionFromCurrentTime = function positionFromCurrentTime(date) {
    var getNow = this.props.getNow;
    var current = getNow();
    var diff = _dates.default.diff(current, date, 'minutes') + this.getDstOffset(current, date);
    console.log(diff);
    return diff;
  };
  ...
  _proto.onEnd = function onEnd() {
    ...
    var x = document.getElementById('rbc-current-time-indicator');
    x.style.transform = 'none'; // console.log(x, '----')
  };
  ...
  _proto.render = function render() {
    ...
    }, _react.default.createElement("span", null, localizer.format(selectDates, 'selectRangeFormat'))), isNow && _react.default.createElement(Box, {
      onValueChange: {
        y: function y(x) {
...
DayColumn.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  onSelectCurrent: _propTypes.default.func,
